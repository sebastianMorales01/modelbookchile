...
class ControlNuevoModelo{
    ...
    public function ingresarModelo(){
        ...
        if (isset($_SESSION['usuario'])) {
            ...
            $nombre_foto1 = $this->email . 'img1'. date('YmdHis',time()).".".$extencion1;

            if(is_uploaded_file($temp1)) {
                move_uploaded_file($temp1,'../uploads/img/'.$nombre_foto1);
            ...
            $nombre_foto2 = $this->email . 'img2'. date('YmdHis',time()).".".$extencion2;
            ...
            $nombre_foto3 = $this->email . 'img3'. date('YmdHis',time()).".".$extencion3;
            ...
            $nombre_foto4 = $this->email . 'img4'. date('YmdHis',time()).".".$extencion4;
